...
function initWorldTrack(_that) {
    ...
    tempurl1 = _that.options.tempurl
    console.log('tempurl1',tempurl1)
    // 检查API
    if (!session.addOSDMarker) {
      console.log('!addOSDMarker')
        return
    }
    ...
    session.on('addAnchors', anchors => {
        ...
        if (anchor) {
            ...
            innerAudioContext.src = 'https://cdn2.ear0.com:3321/preview?soundid=13209&type=mp3'
            console.log('music')
        }
